  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    >
      ...
      <div class="grid gap-4 xl:grid-cols-2">
        <UCard
          v-for="section in [
            { title: 'Алерты ротации', items: props.rotation_alerts },
            { title: 'Алерты доступов', items: props.access_alerts },
            { title: 'Пробелы ownership', items: props.ownership_alerts },
            { title: 'Ревью и инбокс', items: [...props.review_alerts, ...props.inbox_alerts] },
          ]"
          :key="section.title"
          class="border border-default/70"
        >

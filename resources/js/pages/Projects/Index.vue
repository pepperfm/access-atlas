...
Новый проект
                        ...
                        <p class="text-sm text-muted">
                            Ключ система создаст сама из названия. Тебе нужен
                            только смысл проекта.
                        </p>
                    </div>
                </template>
            ...
            <section v-else class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                <UCard v-for="project in props.projects" :key="project.id">
                    <template #header>
                        <div class="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <p
                                    class="mt-1 text-xs tracking-[0.24em] text-muted uppercase"
                                >
                                    {{ project.key }}
                                </p>
                            </div>

...
const reviewDueAt = ref<DateValue>();
...
Новый доступ
                ...
                >
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <UFormField
                            label="Короткое пояснение"
                            :error="form.errors.scope_description"
                        >
                            <UInput
            ...
            <section v-else class="space-y-4">
                ...
                <div class="grid gap-4 xl:grid-cols-3">
                    <UCard v-for="grant in props.access_grants" :key="grant.id">
                        <template #header>
                            <div
                            ...
                            >
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-muted">
                                        {{ grant.project_name }}
                                        <span v-if="grant.environment_name">·
                                            {{ grant.environment_name }}</span>
                                        <span v-if="grant.scope_description">·
                                            {{ grant.scope_description }}</span>
                                    </p>
                                </div>
